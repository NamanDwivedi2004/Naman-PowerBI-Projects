...
- Payment Method Analysis: Breakdown of bookings by payment type such as Uber Pay, Cash, Amazon Pay, and Google Pay.
- Vehicle Type Performance: Analyzes bookings, revenue, and distance covered by vehicle categories like UberX, UberXL, Comfort, Green, and Black.
...
- Peak Travel Hours: Bookings increase significantly during morning (7–10 AM) and evening (4–8 PM) hours, reflecting office commute patterns.
- Weekend Demand Surge: Saturday and Sunday show the highest booking volumes, highlighting increased leisure travel.
- Trip Characteristics: The average trip covers 3 miles with a mean duration of 16 minutes, indicating a focus on short-distance urban travel.
- Vehicle Preference: UberX is the most preferred vehicle type, contributing the highest bookings and total trip distance.
- Day vs Night Usage: Day trips dominate (65%), while night trips account for the remaining demand.
- Location Hotspots: Penn Station / Madison Square is the most frequent pickup point, while Upper East Side North is the top drop-off location.
- Longest Trip Insight: The longest recorded trip spans 144.1 miles, highlighting occasional long-distance travel demand.
